$(document).ready(function() {
    ...
    $('.discard-btn').on('click', function(e) {
        e.preventDefault();
        if(confirm("Are you sure you want to save this as a draft and return to dashboard?")) {
    ...
    $('.final-btn').on('click', function(e) {
        ...
        setTimeout(function() {
            $btn.html('<i class="fa-solid fa-check me-2"></i> Submitted Successfully');
            $btn.removeClass('btn-purple').addClass('btn-success');
